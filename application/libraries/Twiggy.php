			...
			if(!empty($this->_module))
			{
				...
				foreach($module_locations as $loc => $offset)
				{
					...
					if ( is_dir($loc . $this->_module . '/' . $this->_config['themes_base_dir'] . $theme) )
						//Modified to adecuate the function of this code
						array_push($this->_template_locations, $loc . $this->_module . '/' . $this->_config['themes_base_dir'] . $theme);
				}
			}
		}
		//Modified to adecuate the function of this code
		array_push($this->_template_locations , $this->_themes_base_dir . $theme);
